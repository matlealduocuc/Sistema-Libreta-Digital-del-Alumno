...
const CrearReunionApoderadosEducador = () => {
  ...
  const handleCrearReunion = async () => {
    try {
      ...
      fechaReunionDate.setMinutes(fechaReunionDate.getMinutes() - fechaReunionDate.getTimezoneOffset());
            ...
            <div className="mb-2">
              <div className="flex align-middle justify-between mb-2">
                ...
                <button
                  ...
                  className="bg-blue-600 text-white rounded-full p-2 text-sm disabled:opacity-50"
...
export default CrearReunionApoderadosEducador;
