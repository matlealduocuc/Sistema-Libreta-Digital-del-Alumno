        ...
        <div className="flex">
          <div className="flex-shrink-0 w-full flex flex-col items-center justify-center px-6 text-center">
            ...
            <div className="w-full flex justify-center">
              <button
                className="bg-figma-purple text-white w-80 text-lg font-semibold py-3 px-6 rounded-lg shadow-lg hover:bg-blue-700"
                onClick={() => {
...
export default DirectorComunicadosHome;
