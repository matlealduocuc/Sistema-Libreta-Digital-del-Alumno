...
const DirectorAvisosHome = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="fixed top-[24px] z-50 w-full py-3 flex items-center justify-between px-4 bg-figma-purple text-white">
            ...
            >
              ...
              <div className="fixed -bottom-20 w-full flex flex-col justify-center">
                <div className="flex flex-row justify-center">
                  <button
                    className="bg-figma-purple text-white w-80 text-lg font-semibold py-3 px-6 rounded-lg shadow-lg hover:bg-purple-700 transition-colors"
                    onClick={() => {
                      navigate(slide.href);
                    }}
                  >
                ...
                {slide.isSecondButton && (
                  <div className="flex flex-row justify-center mt-2">
                    <button
                      className="bg-purple-500 text-white w-80 text-lg font-semibold py-3 px-6 rounded-lg shadow-lg hover:bg-purple-400 transition-colors"
                      onClick={() => {
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`w-5 h-5 rounded-full ${
              currentIndex === index ? "bg-figma-purple" : "bg-gray-300"
            }`}
          />
        ))}
      </div>
...
export default DirectorAvisosHome;
