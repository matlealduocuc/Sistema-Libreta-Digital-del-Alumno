...
const ListadoNivelesAutorizadosVacunaDirector = () => {
  ...
  useEffect(() => {
    const fetchNiveles = async () => {
      ...
      if (!isLoading) {
        try {
          const nivelesData = await nivelController.getAllNivelesWhereSomeVacuna();
          if (nivelesData) {
            setNiveles(
              nivelesData.map(
                (nivel: {
...
export default ListadoNivelesAutorizadosVacunaDirector;
